...
var RadarChart3 = function () {
  function RadarChart3(data, options) {
    ...
    this.variables.forEach(function (d, i) {
      computePercentileRank(_this.ref_data, d, _this.rank_variables[i]);
    });
    ...
    // Append a g element
    var g = svg_bar$3.append('g').attr('transform', 'translate(' + (cfg.w / 2 + cfg.margin.left) + ',' + (cfg.h / 2 + cfg.margin.top) + ')');
    ...
    if (cfg.legend !== false && _typeof(cfg.legend) === 'object') {
      var legendZone = svg_bar$3.append('g').attr('id', 'legendZone').attr('class', 'legend').attr('transform', 'translate(' + cfg.legend.translateX + ',' + (cfg.legend.translateY + 20) + ')');
  ...
  createClass(RadarChart3, [{
    ...
    value: function changeStudyZone() {
      ...
      this.variables.forEach(function (d, i) {
        computePercentileRank(_this4.ref_data, d, _this4.rank_variables[i]);
      });
      this.data = prepare_data_radar_default(this.ref_data, this.variables);
      this.current_ids = this.ref_data.map(function (d) {
        return d.id;
    ...
    value: function addVariable$$1(code_variable, name_variable) {
      ...
      this.variables.forEach(function (d, i) {
        computePercentileRank(_this5.ref_data, d, _this5.rank_variables[i]);
      });
      this.data = prepare_data_radar_default(this.ref_data, this.variables);
      this.current_ids = this.ref_data.map(function (d) {
        return d.id;
    ...
    value: function removeVariable$$1(code_variable) {
      ...
      this.variables.forEach(function (d, i) {
        computePercentileRank(_this6.ref_data, d, _this6.rank_variables[i]);
      });
      this.data = prepare_data_radar_default(this.ref_data, this.variables);
      this.current_ids = this.ref_data.map(function (d) {
        return d.id;
    ...
    value: function prepareTableStat() {
      ...
      var all_values = this.variables.map(function (v) {
        return _this7.ref_data.map(function (d) {
          return d[v];
        });
      });
      ...
      var features = all_values.map(function (values, i) {
        return {
          ...
          Max: d3.max(values),
          Moyenne: d3.mean(values),
          id: _this7.variables[i],
          Variable: _this7.variables[i],
          'Ma région': my_region[_this7.variables[i]]
        };
      });
      return features;
    }
    ...
    value: function updateMapRegio() {
      ...
      if (!this.map_elem) return;
      this.map_elem.target_layer.selectAll('path').attr('fill', function (d) {
        return _this8.current_ids.indexOf(d.properties[app.current_config.id_field_geom]) > -1 ? app.colors[d.properties[app.current_config.id_field_geom]] || color_countries : color_disabled;
      });
    }
  }, {
    key: 'updateTableStat',
